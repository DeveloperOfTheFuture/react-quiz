      ...
      return (
        <Auxiliary key={controlName + index}>
          <Input label={control.label} value={control.value} valid={control.valid}
            shouldValidation={!!control.validation} touched={control.touched}
      ...
      <div className='QuizCreator'>
        <div>
          ...
          <form onSubmit={this.submitHandler}>
            ...
            <Button type="success" disabled={this.state.quiz.length === 0}
              onClick={this.createQuizHandler}>Создать тест</Button>
